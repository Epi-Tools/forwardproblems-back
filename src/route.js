...
router.get('/api/pools/messages/:id', jwt, admin, pools.getMessagesId)
router.get('/api/pools/max', jwt, pools.getMaxId)
router.get('/api/pools/:id', jwt, admin, pools.getId)
...
router.get('/api/problems', jwt, admin, problems.get)
router.post('/api/problems', validateJson(ValidProblem), jwt, problems.post)
router.put('/api/problems/:id/:status', validateParam(ValidStatus), jwt, admin, problems.putStatus)
router.put('/api/problems/:id', validateParam(ValidId), jwt, admin, problems.putId)
router.get('/api/problems/:id', validateParam(ValidId), jwt, admin, problems.getId)
router.delete('/api/problems/:id', validateParam(ValidId), jwt, admin, problems.deleteId)